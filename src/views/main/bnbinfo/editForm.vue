          ...
          <a-col :md="12" :sm="24">
            <a-form-item label="主图" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
              ...
              >
                ...
                <img style="width: 200px;" v-else-if="url" :src="url" alt="" />
              </a-upload>
            </a-form-item>
          </a-col>
          <a-col :md="12" :sm="24">
            <a-form-item label="营业执照" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
              ...
              >
                ...
                <img style="width: 200px;" v-else-if="url2" :src="url2" alt="" />
              </a-upload>
            </a-form-item>
          </a-col>
        </a-row>
          ...
          <a-col :md="12" :sm="24">
            <a-form-item label="食品经营许可证" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
              ...
              >
                ...
                <img style="width: 200px;" v-else-if="url3" :src="url3" alt="" />
              </a-upload>
            </a-form-item>
          </a-col>
          <a-col :md="12" :sm="24">
            <a-form-item label="身份证-正面" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
              ...
              >
                ...
                <img style="width: 200px;" v-else-if="url4" :src="url4" alt="" />
          ...
          <a-col :md="12" :sm="24">
            <a-form-item label="身份证-反面" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
              ...
              >
                ...
                <img style="width: 200px;" v-else-if="url5" :src="url5" alt="" />
              </a-upload>
            </a-form-item>
          </a-col>
          <a-col :md="12" :sm="24">
            <a-form-item label="特种行业许可证" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
              ...
              >
                ...
                <img style="width: 200px;" v-else-if="url6" :src="url6" alt="" />
              </a-upload>
            </a-form-item>
          </a-col>
        </a-row>
...
<script>
import { bnbInfoEdit } from '@/api/modular/main/bnbinfo/bnbInfoManage'
import Vue from 'vue'
...
export default {
  ...
  methods: {
    ...
    edit(record) {
      ...
      this.url4 = `${this.BASE_URL}/sysFileInfo/preview?id=${record.idCardFront}`
      this.url5 = `${this.BASE_URL}/sysFileInfo/preview?id=${record.idCardBack}`
      this.url6 = `${this.BASE_URL}/sysFileInfo/preview?id=${record.specialBusinessLicense}`
    },
    handleSubmit() {
      const {
        form: { validateFields }

...
export default {
  ...
  methods: {
    ...
    edit(record) {
      ...
      this.endDtDateString = record.endDt
      this.startDtDateString = record.startDt
      this.exclusiveStartDt = record.exclusiveStartDt
      this.exclusiveEndDt = record.exclusiveEndDt
      setTimeout(() => {
